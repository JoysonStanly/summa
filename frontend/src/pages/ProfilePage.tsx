...
const completedProblemsData: CompletedProblem[] = [
  { name: 'Pre, Post, Inorder in one traversal', topic: 'Trees', date: '09/09/25', difficulty: 'Easy' },
  { name: 'Level Order Traversal', topic: 'Trees', date: '09/09/25', difficulty: 'Easy' },
  { name: 'Postorder Traversal', topic: 'Trees', date: '09/09/25', difficulty: 'Easy' },
  { name: 'Preorder Traversal', topic: 'Trees', date: '09/09/25', difficulty: 'Easy' }
];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#111111] text-white">
      ...
      <div className="flex flex-1">
        ...
        <div className="bg-gray-800 p-4 rounded-md mb-6 mx-4 mt-4">
          {user ? (
            <div className="flex flex-col">
              <div className="flex items-center mb-2">
                <h2 className="text-xl font-semibold mr-3">Welcome, {user.name}!</h2>
              ...
              <div className="mb-3 mt-2">
                {/* Progress page has been removed */}
              </div>
              
              <button 
                onClick={logout}
                className="bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded mt-2 w-24"
              >
                Logout
              </button>
            </div>
