...
const EditProblemPage = () => {
    ...
    try {
      ...
      if (problem) {
        ...
        setFormData({
          ...
          constraints: problem.constraints.length > 0 ? problem.constraints.map(c => c.text) : [''],
          hints: [''],
          images: [],
          companies: [''],
          similarProblems: [''],
        ...
        toast.success('Problem Loaded', 'Problem data loaded successfully');
      } else {
        toast.error('Problem Not Found', 'The problem you are trying to edit does not exist');
        navigate('/admin/problems');
      }
    } catch (error) {
      console.error('Failed to load problem:', error);
      toast.error('Load Failed', 'Failed to load problem data');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      toast.info('Saving...', 'Updating problem data');
      ...
      toast.success('Success!', 'Problem updated successfully');
      navigate('/admin/problems');
    } catch (error) {
      console.error('Failed to update problem:', error);
      toast.error('Update Failed', 'Failed to update problem. Please try again.');
    }
  };
      ...
      <main className="flex-1 pl-28 pr-8 py-8">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg">Update problem details, test cases, and solutions</p>
          </div>
        </motion.div>
