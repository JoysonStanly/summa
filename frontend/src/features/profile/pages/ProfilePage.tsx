...
const ProfilePage: React.FC = () => {
  ...
  const { progress, stats, fetchProgress, fetchStats, isLoadingProgress, isLoadingStats, error } = useUserStore();
  ...
  // Convert API progress to DSA stats format
  const dsaStats: DSAStats = stats ? {
    totalSolved: stats.easySolved + stats.mediumSolved + stats.hardSolved,
    totalProblems: stats.totalProblems,
    easy: {
      solved: stats.easySolved,
      total: Math.floor(stats.totalProblems * 0.33) // Approximate
    },
    medium: {
      solved: stats.mediumSolved,
      total: Math.floor(stats.totalProblems * 0.42)
    },
    hard: {
      solved: stats.hardSolved,
      total: Math.floor(stats.totalProblems * 0.25)
    }
  } : dsaStatsData;
