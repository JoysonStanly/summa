...
import { ChevronDown, ChevronUp, Settings, RotateCcw, Maximize2 } from 'lucide-react';
      ...
      {expanded && (
        <div className="flex-1 overflow-y-auto px-4 py-2">
          ...
          <div className="mb-3">
            ...
            <div className="bg-[#0f0f0f] p-2 rounded-md border border-[#1f1f1f]">
              <pre className="text-xs overflow-x-auto">
                {testCases.find(tc => tc.id === selectedTestCase)?.input[0]}
              </pre>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-[#0f0f0f] p-2 rounded-md border border-[#1f1f1f]">
              <pre className="text-xs overflow-x-auto">
                {testCases.find(tc => tc.id === selectedTestCase)?.input[1]}
              </pre>
            </div>
          </div>
        </div>
